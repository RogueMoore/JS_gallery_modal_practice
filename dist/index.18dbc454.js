...
async function loadData(query = '') {
    try {
        showLoadingMessage();
        const response = await fetch(`${BASE_URL}?key=${API_KEY}${query ? `&q=${query}` : ''}`);
        if (response.ok) {
...
},{"simplelightbox":"9ydBq","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","simplelightbox/dist/simple-lightbox.min.css":"kaxSc"}],"9ydBq":[function(require,module,exports,__globalThis) {
/*!
...
},{}],"kaxSc":[function() {},{}]},["80cCk","1SICI"], "1SICI", "parcelRequire94c2")
